...
// Shared container: full-bleed edge padding that scales per breakpoint, with
// a generous max-width so content doesn't stretch edge-to-edge on very large
...
const CONTAINER = "w-full max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-10 xl:px-40";
    ...
    <main id="nf-webinar-page" className="min-h-screen w-full overflow-x-hidden bg-white text-slate-800">
      ...
      <section className="relative overflow-hidden bg-[linear-gradient(160deg,#f8fbff_0%,#edf3fa_100%)] pt-0 pb-6">
        ...
        <div className={`relative ${CONTAINER}`}>
          <div className="grid gap-8 lg:grid-cols-[minmax(0,1.3fr)_minmax(360px,.7fr)] lg:items-center lg:gap-10 xl:gap-14">
            <motion.div
              className="pt-8"
            ...
            >
              ...
              <p className="mt-4 max-w-[58ch] text-base sm:text-[1.02rem] leading-[1.72] text-[#5b6b82]">
              ...
              <div className="mt-5 flex flex-wrap gap-x-6 gap-y-2 text-sm font-semibold text-[#0b2a4a]">
                <span className="inline-flex items-center gap-2"><Check className="h-4 w-4 shrink-0" /> Live online webinar</span>
                <span className="inline-flex items-center gap-2"><Check className="h-4 w-4 shrink-0" /> Interactive Q&amp;A</span>
                <span className="inline-flex items-center gap-2"><Check className="h-4 w-4 shrink-0" /> Practical investment strategy</span>
              </div>

              <div className="mt-7 grid grid-cols-2 gap-4 border-t border-black/10 pt-5">
                <div>
                  <strong className="block text-[1.5rem] sm:text-[1.7rem] font-bold leading-none text-[#d98d1f] font-['Space_Grotesk',sans-serif]">100+</strong>
                  <span className="mt-1 block text-sm text-[#5b6b82]">Live Webinars Hosted</span>
                </div>
                <div>
                  <strong className="block text-[1.5rem] sm:text-[1.7rem] font-bold leading-none text-[#d98d1f] font-['Space_Grotesk',sans-serif]">5,000+</strong>
            ...
            <motion.aside
              id="register"
              className="relative w-full rounded-3xl border border-[#e6ecf3] bg-white p-5 sm:p-7 shadow-[0_30px_80px_-24px_rgba(11,42,74,0.22)]"
              initial={{ opacity: 0, x: 24 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.65, delay: 0.08 }}
            >
              <div className="absolute left-1/2 top-0 h-1 w-20 -translate-x-1/2 rounded-b bg-[#f2a93b]" />
              <h2 className="mb-5 text-center text-xl sm:text-2xl font-bold leading-tight text-[#0b2a4a] font-['Space_Grotesk',sans-serif]">
                Reserve Your Spot
              </h2>
      ...
      ========================================================= */}
      <section className="pt-10 pb-14 sm:pb-19">
          ...
          <div className="grid gap-6 lg:grid-cols-[minmax(0,.95fr)_minmax(0,1.05fr)] lg:items-stretch">
            <div className="space-y-4">
              ...
              <div className="rounded-[28px] bg-[linear-gradient(135deg,#0b2a4a,#143e67)] p-6 text-white shadow-[0_16px_40px_-12px_rgba(11,42,74,0.14)]">
                <h3 className="text-[1.3rem] sm:text-[1.5rem] font-bold leading-tight font-['Space_Grotesk',sans-serif]">
            ...
            <div className="relative min-h-56 sm:min-h-64 lg:min-h-85 overflow-hidden rounded-[28px] bg-[linear-gradient(135deg,#0d4bb3,#1553ba)] shadow-[0_16px_40px_-12px_rgba(11,42,74,0.14)] lg:h-full">
              <Image
      ...
      ========================================================= */}
      <section className="bg-[#f4f8fc] pt-10 pb-14 sm:pb-19">
        <div className={CONTAINER}>
          <div className="mb-7 w-full">
            <span className="inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.16em] text-[#d98d1f] before:block before:h-0.5 before:w-7 before:rounded-full before:bg-[linear-gradient(90deg,#f2a93b,transparent)] before:content-['']">
            ...
            <p className="mt-4 w-full max-w-none lg:max-w-[78ch] text-[#5b6b82]">
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            {(active?.realityCases?.length
              ...
              <article
                key={item.label}
                className={`rounded-[20px] border bg-white p-5 sm:p-6 shadow-[0_2px_12px_rgba(11,42,74,0.06)] transition-transform hover:-translate-y-1 hover:shadow-[0_16px_40px_-12px_rgba(11,42,74,0.14)] ${
          ...
          <div className="mt-6 rounded-[20px] border border-[#e6ecf3] bg-white p-5 sm:p-6 text-[15px] leading-7 text-[#16233a] shadow-[0_2px_12px_rgba(11,42,74,0.06)]">
      ...
      <section className="pt-10 pb-14 sm:pb-19">
        <div className={CONTAINER}>
          ...
          <div className="grid gap-6 lg:grid-cols-[1.2fr_.8fr] lg:items-stretch">
            <div className="flex flex-col gap-4">
              <div className="space-y-2.5">
                {(active?.relateItems?.length
                  ...
                  <div
                    key={item}
                    className="flex items-start gap-3 rounded-2xl border border-[#e6ecf3] bg-white px-4 py-3.5 text-[#16233a] shadow-[0_2px_12px_rgba(11,42,74,0.04)] transition-transform sm:hover:translate-x-1"
                  >
            ...
            <div className="relative min-h-56 sm:min-h-64 lg:min-h-70 overflow-hidden rounded-[28px] bg-[linear-gradient(135deg,#0d4bb3,#1553ba)] shadow-[0_16px_40px_-12px_rgba(11,42,74,0.14)] lg:h-full">
              <Image
        ...
        <div className={CONTAINER}>
          ...
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            {(active?.learningItems?.length
              ...
              <div
                key={title}
                className="flex flex-col rounded-[20px] border border-[#e6ecf3] bg-white p-5 sm:p-6 shadow-[0_2px_12px_rgba(11,42,74,0.06)] transition-all hover:-translate-y-1.5 hover:border-[#f2a93b]/40 hover:shadow-[0_16px_40px_-12px_rgba(11,42,74,0.14)]"
              >
                <strong className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[#0b2a4a] font-[Space_Grotesk] text-white">
      ...
      ========================================================= */}
      <section className="pt-10 pb-10 sm:pb-19">
        <div className={CONTAINER}>
          <div className="mb-7 w-full">
            <span className="inline-flex items-center gap-2 text-[11px] font-bold uppercase tracking-[0.16em] text-[#d98d1f] before:block before:h-0.5 before:w-7 before:rounded-full before:bg-[linear-gradient(90deg,#f2a93b,transparent)] before:content-['']">
          ...
          <div className="grid gap-5 md:grid-cols-2">
            <div className="rounded-[20px] border border-[#e6ecf3] bg-white p-6 sm:p-7 shadow-[0_2px_12px_rgba(11,42,74,0.06)]">
            ...
            <div className="rounded-[20px] bg-[linear-gradient(135deg,#0b2a4a,#123a63)] p-6 sm:p-7 shadow-[0_16px_40px_-12px_rgba(11,42,74,0.14)]">
          ...
          <p className="mx-auto mt-6 max-w-[62ch] text-center text-base sm:text-[1.02rem] font-semibold leading-7 text-[#0b2a4a]">
      ...
      <section className="bg-[#f4f8fc] pb-10 pt-10">
        <div className={CONTAINER}>
          <div className="relative overflow-hidden rounded-[2rem] sm:rounded-4xl bg-[linear-gradient(135deg,#0b2a4a_0%,#123a63_50%,#0b2a4a_100%)] p-6 sm:p-8 lg:p-12 text-white">
            ...
            <div className="relative">
              <h2 className="text-[clamp(1.5rem,5vw,2.4rem)] font-bold tracking-[-0.02em] font-['Space_Grotesk',sans-serif]">
            ...
            <div className="relative mt-7 grid gap-4 sm:grid-cols-2 pb-6">
              {CONTACT_BRANDS.map((brand) => (
                <div key={brand.name} className="rounded-[18px] border border-white/15 bg-white/10 p-5 sm:p-6 backdrop-blur">
                  <h3 className="text-[1.15rem] font-bold font-['Space_Grotesk',sans-serif]">{brand.name}</h3>
                  <div className="mt-4 flex flex-col gap-2.5 text-sm">
                    <a href={`mailto:${brand.email}`} className="inline-flex w-fit items-center gap-2.5 text-[#e7eff8] transition-colors hover:text-[#ffd17a] break-all">
                    ...
                    {Object.entries(brand.socials).map(([platform, url]) => {
                      ...
                      return (
                        <a
                          ...
                          className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-white/15 bg-white/10 text-white transition-all hover:-translate-y-0.5 hover:border-[#f2a93b] hover:bg-[#f2a93b] hover:text-[#0b2a4a]"
                        >
            ...
            <footer className="border-t border-white/15 pt-5 text-center text-[0.8rem] text-white/70">
